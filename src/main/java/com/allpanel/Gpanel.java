...
import com.allchart.GLineChart;
import com.db.ConnMySQL;
import com.frame.BackgroundPanel;

public class Gpanel extends JPanel {// 第七位开奖号码走势面板

	public Gpanel() {// 第七位开奖号码走势面板
		this.setBorder(new EmptyBorder(5, 5, 5, 5));// 设置第七位开奖号码走势面板的边框样式
		setLayout(new BorderLayout(0, 0));// 设置第七位开奖号码走势面板的布局为边界布局
		...
		button.setText("查看最近10期的第七位开奖号码走势图");
	...
	protected void do_button_actionPerformed(ActionEvent e) {// “查看最近10期的第七位开奖号码走势图”动作事件的监听
		GLineChart chart = new GLineChart(null, "第七位开奖号码走势图");// 创建“第七位开奖号码走势图”折线图窗体对象
