...
public class Apanel extends JPanel {// 第一位开奖号码走势面板
	...
	public Apanel() {// 第一位开奖号码的走势面板
		...
		progressBar_0.setForeground(new Color(255, 165, 0));// 设置与“0:”标签对应的进度条中的前景色
		progressBar_0.setStringPainted(true);// 设置与“0:”标签对应的进度条呈现进度字符串
		progressBar_0.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“0:”标签对应的进度条的字体样式和大小
		...
		progressBar_1.setForeground(new Color(255, 165, 0));// 设置与“1:”标签对应的进度条中的前景色
		progressBar_1.setStringPainted(true);// 设置与“1:”标签对应的进度条呈现进度字符串
		progressBar_1.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“1:”标签对应的进度条的字体样式和大小
		...
		progressBar_2.setForeground(new Color(255, 165, 0));// 设置与“2:”标签对应的进度条中的前景色
		progressBar_2.setStringPainted(true);// 设置与“1:”标签对应的进度条呈现进度字符串
		progressBar_2.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“2:”标签对应的进度条的字体样式和大小
		...
		progressBar_3.setForeground(new Color(255, 165, 0));// 设置与“3:”标签对应的进度条中的前景色
		progressBar_3.setStringPainted(true);// 设置与“3:”标签对应的进度条呈现进度字符串
		progressBar_3.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“3:”标签对应的进度条的字体样式和大小
		...
		progressBar_4.setForeground(new Color(255, 165, 0));// 设置与“4:”标签对应的进度条中的前景色
		progressBar_4.setStringPainted(true);// 设置与“4:”标签对应的进度条呈现进度字符串
		progressBar_4.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“4:”标签对应的进度条的字体样式和大小
		...
		progressBar_5.setForeground(new Color(255, 165, 0));// 设置与“5:”标签对应的进度条中的前景色
		progressBar_5.setStringPainted(true);// 设置与“5:”标签对应的进度条呈现进度字符串
		progressBar_5.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“5:”标签对应的进度条的字体样式和大小
		...
		progressBar_6.setForeground(new Color(255, 165, 0));// 设置与“6:”标签对应的进度条中的前景色
		progressBar_6.setStringPainted(true);// 设置与“6:”标签对应的进度条呈现进度字符串
		progressBar_6.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“6:”标签对应的进度条的字体样式和大小
		...
		progressBar_7.setForeground(new Color(255, 165, 0));// 设置与“7:”标签对应的进度条中的前景色
		progressBar_7.setStringPainted(true);// 设置与“7:”标签对应的进度条呈现进度字符串
		progressBar_7.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“7:”标签对应的进度条的字体样式和大小
		...
		progressBar_8.setForeground(new Color(255, 165, 0));// 设置与“8:”标签对应的进度条中的前景色
		progressBar_8.setStringPainted(true);// 设置与“8:”标签对应的进度条呈现进度字符串
		progressBar_8.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“8:”标签对应的进度条的字体样式和大小
		...
		progressBar_9.setForeground(new Color(255, 165, 0));// 设置与“9:”标签对应的进度条中的前景色
		progressBar_9.setStringPainted(true);// 设置与“9:”标签对应的进度条呈现进度字符串
		progressBar_9.setFont(new Font("微软雅黑", Font.PLAIN, 14));// 设置与“9:”标签对应的进度条的字体样式和大小
	...
	protected void do_button_actionPerformed(ActionEvent e) {// “查看最近10期的第一位开奖号码走势图”动作事件的监听
		ALineChart chart = new ALineChart(null, "第一位开奖号码走势图");// 创建“第一位开奖号码走势图”折线图窗体对象
