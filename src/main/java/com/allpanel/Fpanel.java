...
import com.allchart.FLineChart;
import com.db.ConnMySQL;
import com.frame.BackgroundPanel;

public class Fpanel extends JPanel {// 第六位开奖号码走势面板

	public Fpanel() {// 第六位开奖号码走势面板
		this.setBorder(new EmptyBorder(5, 5, 5, 5));// 设置第六位开奖号码走势面板的边框样式
		setLayout(new BorderLayout(0, 0));// 设置第六位开奖号码走势面板的布局为边界布局
		...
		button.setText("查看最近10期的第六位开奖号码走势图");
	...
	protected void do_button_actionPerformed(ActionEvent e) {// “查看最近10期的第六位开奖号码走势图”动作事件的监听
		FLineChart chart = new FLineChart(null, "第六位开奖号码走势图");// 创建“第六位开奖号码走势图”折线图窗体对象
