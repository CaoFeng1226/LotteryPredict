...
/*    */ 
/*    */ public class BLineChart extends JFrame
/*    */ {
/*    */   public BLineChart(String applicationTitle, String chartTitle)
/*    */   {
...
/*    */ 
/* 87 */     dataset.addValue(((History)list.get(0)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(0)).getNumber() + "期");
/* 88 */     dataset.addValue(((History)list.get(1)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(1)).getNumber() + "期");
/* 89 */     dataset.addValue(((History)list.get(2)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(2)).getNumber() + "期");
/* 90 */     dataset.addValue(((History)list.get(3)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(3)).getNumber() + "期");
/* 91 */     dataset.addValue(((History)list.get(4)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(4)).getNumber() + "期");
/* 92 */     dataset.addValue(((History)list.get(5)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(5)).getNumber() + "期");
/* 93 */     dataset.addValue(((History)list.get(6)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(6)).getNumber() + "期");
/* 94 */     dataset.addValue(((History)list.get(7)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(7)).getNumber() + "期");
/* 95 */     dataset.addValue(((History)list.get(8)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(8)).getNumber() + "期");
/* 96 */     dataset.addValue(((History)list.get(9)).getB(), "第二位开奖号码走势线", "第" + ((History)list.get(9)).getNumber() + "期");
/* 97 */     return dataset;
/*    */   }
/*    */ }

/* Location:           C:\Develop_file\Java Decompiler\linechartgraph\
 * Qualified Name:     com.allchart.BLineChart
